...
<template>
  <div>
    ...
    <section
      id="section1"
      class="bg-[#F8F4EC] w-full justify-center pt-6 md:pt-0"
    >
      <div class="flex flex-wrap gap-4 w-[90%] mx-auto">
        <div
          class="relative group w-full sm:max-w-[48%] md:max-w-[31%] lg:max-w-[23%]"
          data-aos="zoom-in"
        ...
        >
          ...
          >
            <h3
              class="text-4xl font-times capitalize group-hover:text-[#38544c] transition-all duration-300 mb-3"
            >
              {{ cluster.name }}
            </h3>
            <div class="flex items-center justify-start">
              <NuxtLink
                ...
                class="text-white group-hover:text-[#38544c] transition-all duration-300 text-[10px] font-bold"
                >VIEW GALLERY</NuxtLink
              >
            </div>
          </div>
        </div>
      ...
      <div class="pt-8 pb-10 text-center">
        <button
          class="flex items-center pt-5 mx-auto btn-visit-black"
          data-aos="fade-up"
          data-aos-delay="300"
        >
