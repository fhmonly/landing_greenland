<template>
  <div>
    ...
    <section id="section2" class="bg-[#3c4f4b] h-screen">
      ...
      <h1 class="relative inset-x-0 bottom-0 gradient-text" data-aos="slide-up">
        Greenland
      </h1>
    </section>

    <section id="section3" class="bg-center bg-cover" data-aos="fade-up" :style="`background-image: url('${config.public.dirUrl}/images/static/${settings.data.about1_image_banner}')`">
    </section>
      ...
      <div class="grid items-center justify-center h-full">
        ...
        <div class="flex order-1 w-full place-items-end md:order-2">
          ...
          <div class="w-full pl-0 m-5 md:w-3/4 md:pl-3 md:m-0" data-aos="fade-down">
            <img :src="`${config.public.dirUrl}/images/static/${settings.data.about2_image_banner}`" alt="" class="place-items-end" height="10px" />
          </div>
        </div>
      </div>
    </section>
    <section id="section5" class="bg-[#2c3c34] h-fit">
      <div class="flex flex-col px-4 pt-12 mx-auto mb-8 md:flex-row md:px-16 md:pt-24 md:mb-16" data-aos="fade-up"
        ...
        <div class="md:w-2/4 w-full font-nunito text-[#f5f4ed] text-md text-center md:text-left">
          <span class="font-thin text-[14px]">{{settings.data.about3_small_title}}</span> <br />
        </div>
