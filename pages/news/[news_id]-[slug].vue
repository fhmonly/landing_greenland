          ...
          <div class="flex flex-col md:flex-row">
            <div class="mx-auto">
              ...
              <div class="mx-auto mb-8 md:mb-0">
                <NuxtImg :placeholder="[50, 25, 75, 5]" format="webp" :src="`/greenland/${results.image}`"
                  alt="Gambar Utama Artikel" class="object-cover w-full h-auto" />
              </div>
              ...
              <div class="pt-8 pb-10 text-center">
                <NuxtLink to="/news" class="items-center pt-5 mx-auto flex-block btn-visit-black" data-aos="fade-up"
                  data-aos-delay="300">
