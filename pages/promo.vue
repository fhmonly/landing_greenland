<template>
  <div>
    ...
    >
      <div class="w-full">
        <div
          class="flex flex-wrap items-center justify-center w-full gap-4 px-2 pb-4"
        >
          <div
            ...
            v-for="promo in promos.data.data"
            :key="promo"
          >
            <div>
              <p class="text-[10px] font-semibold">
                NEWS - {{ $dayjs(promo.date_input).locale("id").fromNow() }}
              </p>
            ...
            <div class="mt-auto">
              ...
              <NuxtLink
                ...
                :href="`/promos/${promo.topik_id}`"
                class="mb-4 text-[10px] font-bold"
                >READ MORE</NuxtLink
              >
            </div>
          </div>
